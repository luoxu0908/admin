...
AutoCompleteTextBox.prototype.submitBtn = null;
...
AutoCompleteTextBox.prototype.TextBox_KeyUp = function(oEvent)
{
	...
	if (!this.CTRLdown)
	{
		if( iKeyCode == 8 || iKeyCode == 46 || iKeyCode == 27)
		{
			...
			if (this.TextBox.value.length == 0 || iKeyCode == 27) {return;}
		}
		...
		if( txt.length > 0 )
		{
			...
			if (this.Coords.x == 0 && this.Coords.y == 0)
			{
				...
				this.Div.style.top = (this.Coords.y + n) + 'px';
			}
...
AutoCompleteTextBox.prototype.Div_MouseDown = function()
{
	...
	//this.AutoCompleteTextBox.SetSelection();
	if (!this.isFocus)
	{
...
AutoCompleteTextBox.prototype.Div_MouseOut = function()
{
  /*if( this.AutoCompleteTextBox.ListItemClass.length > 0 )
	...
	//this.AutoCompleteTextBox.ResetSuggestion();
}

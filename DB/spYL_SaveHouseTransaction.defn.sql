...
@FXMS nvarchar(max),@Picture NVARCHAR(max),@PictureGUID NVARCHAR(max), @ZDTJ nvarchar(10),@LoginID int,@Success bit OUTPUT,@RetMsg nvarchar(max) output,@OrderID nvarchar(50) output)
AS
BEGIN
	SET NOCOUNT ON;
